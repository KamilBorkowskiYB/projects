...
btn_equal = tk.Button(window, text="=", command=lambda: evaluate_calculation(), width=11, font=("Arial", 14))
btn_equal.grid(row=6, column=3, columnspan=2)
btn_clear = tk.Button(window, text="Clear", command=lambda: clear_field(), width=11, font=("Arial", 14))
